...
class ShopController extends Controller {
    ...
    {       		
        $carrinho =  \App\Classes\Cart::carrinho();
        $produtos =  \App\CartProduct::where('cart_id','=',$carrinho->id)->get();
        //foreach ($produtos as $produto) {
          //  print_r($produtos->toJson());
       // }
    ...
    {          
      ...
      try {
        $carrinho =  \App\Classes\Cart::add($request->product_id);
       // echo 'OK';
      } catch (Exception $e) {
        //echo $e->getMessage();
      }
